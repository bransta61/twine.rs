...
export class TwineWasmProjectSession {
    free(): void;
    [Symbol.dispose](): void;
    accept_semantic_reference_occurrences(task_id: bigint, source_id: string, occurrences: any): any;
    ...
    begin_semantic_references(story_id: string, passage_id: string, identity: any): any;
    can_redo(): boolean;
    can_undo(): boolean;
    cancel_passage_rename_plan(task: any): boolean;
    cancel_project_replace_plan(task: any): boolean;
    cancel_semantic_references(task_id: bigint): void;
    continue_passage_rename_plan(task: any): any;
    continue_project_replace_plan(task: any): any;
    finish_semantic_reference_source(task_id: bigint, source_id: string): void;
    finish_semantic_references(task_id: bigint): void;
    ingest_external_delta(delta: any, force: boolean): any;
    invalidate_semantic_provider(story_id: string): void;
    constructor(snapshot: any);
    next_semantic_reference_source(task_id: bigint): any;
    ...
    query_semantic_references_page(story_id: string, passage_id: string, identity: any, query: any): any;
    ...
    read_semantic_reference_source_chunk(task_id: bigint, source_id: string, offset: number, max_bytes: number): string;
    redo(): any;
    revision(): number;
...
export interface InitOutput {
    ...
    readonly twinewasmprojectsession_accept_semantic_reference_occurrences: (a: number, b: bigint, c: number, d: number, e: any) => [number, number, number];
    ...
    readonly twinewasmprojectsession_begin_semantic_references: (a: number, b: number, c: number, d: number, e: number, f: any) => [number, number, number];
    ...
    readonly twinewasmprojectsession_cancel_semantic_references: (a: number, b: bigint) => void;
    ...
    readonly twinewasmprojectsession_finish_semantic_reference_source: (a: number, b: bigint, c: number, d: number) => [number, number];
    readonly twinewasmprojectsession_finish_semantic_references: (a: number, b: bigint) => [number, number];
    readonly twinewasmprojectsession_ingest_external_delta: (a: number, b: any, c: number) => [number, number, number];
    readonly twinewasmprojectsession_invalidate_semantic_provider: (a: number, b: number, c: number) => void;
    readonly twinewasmprojectsession_new: (a: any) => [number, number, number];
    readonly twinewasmprojectsession_next_semantic_reference_source: (a: number, b: bigint) => [number, number, number];
    ...
    readonly twinewasmprojectsession_query_semantic_references_page: (a: number, b: number, c: number, d: number, e: number, f: any, g: any) => [number, number, number];
    ...
    readonly twinewasmprojectsession_read_semantic_reference_source_chunk: (a: number, b: bigint, c: number, d: number, e: number, f: number) => [number, number, number, number];
