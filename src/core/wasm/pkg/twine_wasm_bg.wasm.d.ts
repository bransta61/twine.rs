...
export const twinewasmprojectsession_accept_semantic_reference_occurrences: (a: number, b: bigint, c: number, d: number, e: any) => [number, number, number];
...
export const twinewasmprojectsession_begin_semantic_references: (a: number, b: number, c: number, d: number, e: number, f: any) => [number, number, number];
...
export const twinewasmprojectsession_cancel_semantic_references: (a: number, b: bigint) => void;
...
export const twinewasmprojectsession_finish_semantic_reference_source: (a: number, b: bigint, c: number, d: number) => [number, number];
export const twinewasmprojectsession_finish_semantic_references: (a: number, b: bigint) => [number, number];
export const twinewasmprojectsession_ingest_external_delta: (a: number, b: any, c: number) => [number, number, number];
export const twinewasmprojectsession_invalidate_semantic_provider: (a: number, b: number, c: number) => void;
export const twinewasmprojectsession_new: (a: any) => [number, number, number];
export const twinewasmprojectsession_next_semantic_reference_source: (a: number, b: bigint) => [number, number, number];
...
export const twinewasmprojectsession_query_semantic_references_page: (a: number, b: number, c: number, d: number, e: number, f: any, g: any) => [number, number, number];
...
export const twinewasmprojectsession_read_semantic_reference_source_chunk: (a: number, b: bigint, c: number, d: number, e: number, f: number) => [number, number, number, number];
